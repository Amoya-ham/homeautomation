...
static const char* subtopic[]    = {"62011390_sub","/elet2415"};  // Array of Topics(Strings) to subscribe to
...
void checkPasscode(void){
    ...
    if(WiFi.status()== WL_CONNECTED){ 
      ...
      http.begin(client, "http://172.16.193.146:8080/api/check/combination"); // Your Domain name with URL path or IP address with path 
